...
#define TEST_C500_MMA_GEMM_BF16
#define TEST_C500_MEMORY_ASYNC_BSM
#define TEST_C500_MEMORY_RAW_GEMM_ASYNC
...
#define TEST_C500_GEMM_STAGE_PROBE
#define TEST_C500_GEMM_OPERAND_STAGE_PROBE
#define TEST_C500_GEMM_OPERAND_BRIDGE_PROBE
#define TEST_C500_GEMM_SMOKE
#define TEST_C500_GEMM_LAYOUTA_NATIVE_SMOKE
#endif
...
#define TEST_GROUP_MMA
    ...
    defined(TEST_C500_GEMM_FRAGMENT_PROBE) || defined(TEST_C500_GEMM_STAGE_PROBE) || defined(TEST_C500_GEMM_STAGE_ASYNC_PROBE) || \
    defined(TEST_C500_GEMM_RAW_VECTOR_GEMM_PROBE) || defined(TEST_C500_GEMM_OPERAND_STAGE_PROBE) || defined(TEST_C500_GEMM_NATIVE_COORD_PROBE) || defined(TEST_C500_GEMM_OPERAND_LAYOUT_PROBE) || defined(TEST_C500_GEMM_OPERAND_BRIDGE_PROBE) || defined(TEST_C500_GEMM_OPERAND_DIRECT_ASYNC_PROBE) || defined(TEST_C500_GEMM_OPERAND_B_LAYOUTA_DIRECT_ASYNC_PROBE) || defined(TEST_C500_GEMM_OPERAND_LAYOUTA_ATOM_PROBE) || defined(TEST_C500_GEMM_SMOKE) || defined(TEST_C500_GEMM_BALANCED_FAMILY_SMOKE) || defined(TEST_C500_GEMM_LAYOUTA_NATIVE_SMOKE) || \
    defined(TEST_C500_MMA_ATOM_BF16) || defined(TEST_C500_MMA_GEMM_BF16)
#define TEST_C500_MMA
#endif

#if defined(TEST_C500_MEMORY_ASYNC_BSM) || defined(TEST_C500_MEMORY_SHARED_TO_NATIVE_A) || defined(TEST_C500_MEMORY_SHARED_TO_NATIVE_B)
