...
layoutc_stage4_device(
    ...
    for (; K >= 128; K -= 128) {
        {
            C_f32[0][0] = mma_atom::fma_pair<T>(
                b[0][0][0], b[0][0][1], a[0][0][0], a[0][0][1], C_f32[0][0]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(0, 0),
                                       APtr + ALdgOffset[0][0]);
            C_f32[0][0] = mma_atom::fma_pair<T>(
            ...
            C_f32[1][0] = mma_atom::fma_pair<T>(
                b[0][0][0], b[0][0][1], a[1][0][0], a[1][0][1], C_f32[1][0]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(0, 1),
                                       APtr + ALdgOffset[1][0]);
            C_f32[1][0] = mma_atom::fma_pair<T>(
            ...
            a[2][0] = reload_atom::load_fragment<ALdsType>(
                WSM_lds + stage_layout::stage_base_offset(2), ALdsOffset, 0);
            C_f32[0][1] = mma_atom::fma_pair<T>(
            ...
            a[2][2] = reload_atom::load_fragment<ALdsType>(
            ...
            a[2][3] = reload_atom::load_fragment<ALdsType>(
            ...
            b[2][0] = reload_atom::load_fragment<BLdsType>(
                WSM_lds + stage_layout::stage_base_offset(2), BLdsOffset, 0);

            C_f32[1][1] = mma_atom::fma_pair<T>(
            ...
            b[2][2] = reload_atom::load_fragment<BLdsType>(
            ...
            b[2][3] = reload_atom::load_fragment<BLdsType>(
            ...
            C_f32[2][0] = mma_atom::fma_pair<T>(
                b[0][0][0], b[0][0][1], a[2][0][0], a[2][0][1], C_f32[2][0]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(1, 0),
                                       APtr + ALdgOffset[0][1]);
            C_f32[2][0] = mma_atom::fma_pair<T>(
            ...
            C_f32[2][1] = mma_atom::fma_pair<T>(
                b[1][0][0], b[1][0][1], a[2][0][0], a[2][0][1], C_f32[2][1]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(1, 1),
                                       APtr + ALdgOffset[1][1]);
            C_f32[2][1] = mma_atom::fma_pair<T>(
            ...
            a[3][0] = reload_atom::load_fragment<ALdsType>(
            ...
            a[3][1] = reload_atom::load_fragment<ALdsType>(
            ...
            a[3][2] = reload_atom::load_fragment<ALdsType>(
                WSM_lds + stage_layout::stage_base_offset(3), ALdsOffset, 2);

            C_f32[0][2] = mma_atom::fma_pair<T>(
            ...
            b[3][0] = reload_atom::load_fragment<BLdsType>(
            ...
            b[3][1] = reload_atom::load_fragment<BLdsType>(
            ...
            b[3][2] = reload_atom::load_fragment<BLdsType>(
                WSM_lds + stage_layout::stage_base_offset(3), BLdsOffset, 2);

            C_f32[1][2] = mma_atom::fma_pair<T>(
            ...
            C_f32[2][2] = mma_atom::fma_pair<T>(
                b[2][0][0], b[2][0][1], a[2][0][0], a[2][0][1], C_f32[2][2]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(2, 0),
                                       APtr + ALdgOffset[0][2]);
            C_f32[2][2] = mma_atom::fma_pair<T>(
            ...
            C_f32[3][0] = mma_atom::fma_pair<T>(
                b[0][0][0], b[0][0][1], a[3][0][0], a[3][0][1], C_f32[3][0]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(2, 1),
                                       APtr + ALdgOffset[1][2]);
            C_f32[3][0] = mma_atom::fma_pair<T>(
            ...
            C_f32[3][2] = mma_atom::fma_pair<T>(
                b[2][0][0], b[2][0][1], a[3][0][0], a[3][0][1], C_f32[3][2]);
            copy_atom::issue_b128_bsm_no_pred(WSM_Ldg + stage_layout::a_stage_offset(3, 1),
                                       APtr + ALdgOffset[1][3]);
            C_f32[3][2] = mma_atom::fma_pair<T>(
            ...
            a[1][0] = reload_atom::load_fragment<ALdsType>(
            ...
            a[1][1] = reload_atom::load_fragment<ALdsType>(
                WSM_lds + stage_layout::stage_base_offset(1), ALdsOffset, 1);

            C_f32[2][3] = mma_atom::fma_pair<T>(
            ...
            a[1][3] = reload_atom::load_fragment<ALdsType>(
            ...
            b[1][0] = reload_atom::load_fragment<BLdsType>(
            ...
            b[1][1] = reload_atom::load_fragment<BLdsType>(
                WSM_lds + stage_layout::stage_base_offset(1), BLdsOffset, 1);

            C_f32[3][3] = mma_atom::fma_pair<T>(
            ...
            b[1][3] = reload_atom::load_fragment<BLdsType>(
    ...
    if (K > 0) {
        for (int stage_i = 0; stage_i < Stage; ++stage_i) {
            tail_atom::run_tail_iteration<T, Stage, FLOAT4, ALdsType, BLdsType,
                                          ALdgType, BLdgType>(
    ...
    tail_atom::drain_tail<T, Stage>(C_f32, a, b, WSM_lds, ALdsOffset, BLdsOffset);
